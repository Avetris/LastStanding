...
namespace UnityEngine.UI.Extensions
{
    ...
    public class RangeSliderEditor : SelectableEditor
    {
        ...
        SerializedProperty m_StepSize;
        // SerializedProperty m_WholeNumbers;

        SerializedProperty m_LowValue;
        SerializedProperty m_HighValue;

        SerializedProperty m_OutputFromText;
        SerializedProperty m_OutputToText;
        ...
        protected override void OnEnable()
        {
            ...
            m_OutputFromText = serializedObject.FindProperty("m_OutputFromText");
            m_OutputToText = serializedObject.FindProperty("m_OutputToText");

            m_MinValue = serializedObject.FindProperty("m_MinValue");
            m_MaxValue = serializedObject.FindProperty("m_MaxValue");
            // m_WholeNumbers = serializedObject.FindProperty("m_WholeNumbers");
            m_StepSize = serializedObject.FindProperty("m_StepSize");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_OutputFromText);
            EditorGUILayout.PropertyField(m_OutputToText);
